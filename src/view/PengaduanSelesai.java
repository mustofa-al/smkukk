 ...
 * @author A
 */
public class PengaduanSelesai extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        tabelPengaduan.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Tanggal Pengaduan", "Oleh", "Isi Laporan", "Tanggapan"
            }
        ) {
        ...
        labelInfo.setText("Pengaduan Selesai");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(PengaduanSelesai.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new PengaduanSelesai().setVisible(true);
            }
        });
    }
